    ...
    private function fetchCities(Client $client): void
    {
        ...
        foreach ($countriesAndItsStates as $countryAndState) {
            try {
                ...
                // [2024-01-19 03:40:23] local.ERROR: D:\Customers\flisolapp\accounts-api\vendor\guzzlehttp\guzzle\src\Exception\RequestException.php [113]: Client error: `POST https://countriesnow.space/api/v0.1/countries/state/cities` resulted in a `404 Not Found` response:
